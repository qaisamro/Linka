              ...
              jobs.map(job => (
                <div key={job.id} className="group p-6 rounded-2xl bg-[#F9F5F0] hover:bg-[#F9F5F0] border border-[#F9F5F0] transition-all flex flex-col md:flex-row items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-3 w-full md:w-auto">
                    <div className="px-4 py-2 rounded-xl bg-[#F9F5F0] text-[#344F1F] text-xs font-black">
                      {job.type}
                    </div>
                    <button className="p-2 text-[#F4991A] hover:text-[#344F1F] transition-all">
                      <Edit size={18} />
                    </button>
                    <button className="p-2 text-[#F4991A] hover:text-[#344F1F] transition-all">
                      <Trash2 size={18} />
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-[#344F1F]/60 backdrop-blur-sm">
          ...
          >
            <div className="p-8 border-b border-[#F9F5F0] flex justify-between items-center bg-[#F9F5F0]/20">
              ...
              <button onClick={() => setIsModalOpen(false)} className="p-2 hover:bg-[#F9F5F0] rounded-xl transition-all">
            ...
            <div className="p-6">
              {appsLoading ? (
                ...
                <div className="space-y-3">
                  {applications.map((a) => (
                    <div key={a.id} className="p-4 rounded-2xl bg-[#F9F5F0] border border-[#F9F5F0] flex flex-col md:flex-row md:items-center justify-between gap-3">
                      <div>
